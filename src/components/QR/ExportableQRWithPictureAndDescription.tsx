 ...
 */
const ExportableQRWithPictureAndDescription = ({
  qrData,
  theme,
  profileUri,
  name,
  ...
  return (
    <View style={{...styles.container, backgroundColor: Colors.surface}}>
      ...
      {description && (
        <NumberlessText
          style={{paddingHorizontal: Spacing.l, marginTop: Spacing.s, overflow: 'visible', textAlign: 'center'}}
          fontWeight={FontWeight.rg}
          textColor={Colors.text.subtitle}
          fontSizeType={FontSizeType.m}>
          {description}
...
export default ExportableQRWithPictureAndDescription;
