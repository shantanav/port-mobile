...
abstract class PortReader {
  ...
  constructor(portData: any) {
    (this.constructor as typeof PortReader).validate(portData);
  ...
  static validate(portData: any) {
    console.log('Validating read port data: ', portData);
  }
  ...
  static async accept(bundleData: any, folderId: string = defaultFolderId) {
    console.log('accepting read port bundle data: ', bundleData, folderId);
  }
